...
const templateRoute = (app) => {
  app.post("/api/v2/templates", (req, res) =>
  ...
  app.put("/api/v2/templates/:id/activate", (req, res) =>
    templateController.activateTemplate(req, res)
  );
  app.put("/api/v2/templates/:id/deactivate", (req, res) =>
    templateController.deactivateTemplate(req, res)
  );
  app.put("/api/v2/templates/:id", (req, res) =>
